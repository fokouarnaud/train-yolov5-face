...
!mkdir -p /content
!cp /content/drive/MyDrive/yolov5_face_scripts/main.py /content/drive/MyDrive/yolov5_face_scripts/data_preparation.py /content/drive/MyDrive/yolov5_face_scripts/model_training.py /content/drive/MyDrive/yolov5_face_scripts/model_evaluation.py /content/drive/MyDrive/yolov5_face_scripts/utils.py /content/drive/MyDrive/yolov5_face_scripts/colab_setup.py /content/
